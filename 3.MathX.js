...
const MathX = {
  findNthFibonacci: (n, sequence = [1, 1]) => {
    if (n < 2) {
      return 1; // первые два элемента в данном примере нужно обозначать вруччную, так как первый элемент выдаст undefined
    }
...
// примеры
console.log(MathX.findNthFibonacci(7)); // 13
